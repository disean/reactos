...
/*
 * This driver is only used if a platform has no ISA PnP support.
 * We need to keep FDO because ACPI driver depends on it.
 */
...
static DRIVER_DISPATCH_PAGED IsaStubCreateClose;
...
static DRIVER_DISPATCH_PAGED IsaStubForward;
...
static DRIVER_DISPATCH_PAGED IsaStubPnp;
...
static DRIVER_ADD_DEVICE IsaStubAddDevice;
...
static DRIVER_UNLOAD IsaStubUnload;
